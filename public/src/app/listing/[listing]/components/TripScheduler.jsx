    ...
    if (userInfo) {
      const data = {
        ...
        tripInfo : {
          ...
          price: `S.P${currentListing.price * calculateDaysDifference()}`,
        },
      };
   ...
   return (
     <div className="sticky top-0 w-full flex flex-col gap-6 items-center justify-center">
      <div className="border border-gray-400 rounded-lg shadow-lg flex p-4 gap-2 items-start px-8 flex-col w-full">
        <div className="flex gap-1 text-lg">
          <span className="font-bold"> {currentListing.price} S.P</span>
          <span>night</span>
        </div>
      ...
      <button
        ...
        <div className="flex justify-between w-full">
          <span>
          {currentListing.price} S.P  x {calculateDaysDifference()} nights
          </span>
          <span>{currentListing.price * calculateDaysDifference()} S.P </span>
        </div>
        <div className="flex justify-between w-full">
     ...
     <div className="flex border border-gray-400 rounded-lg p-4 gap-2 items-start px-8">
      <span>
        ...
        {currentListing?.listingCreatedBy?.firstName}'s place on Syrenta is 
